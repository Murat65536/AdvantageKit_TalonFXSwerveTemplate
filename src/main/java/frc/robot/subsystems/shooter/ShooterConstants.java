...
public class ShooterConstants {
  ...
  public static final LinearVelocity SHOOTER_EXIT_VELOCITY = MetersPerSecond.of(16.0); // reference
  ...
  public static final double EXIT_VELOCITY_PER_FLYWHEEL_RAD_PER_SEC =
      SHOOTER_EXIT_VELOCITY.in(MetersPerSecond) / SHOOTER_READY_VELOCITY.in(RadiansPerSecond);
