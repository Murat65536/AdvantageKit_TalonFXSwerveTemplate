...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  private final MotionMagicExpoVoltage motionMagicVoltageRequest = new MotionMagicExpoVoltage(0.0);
  private final VelocityVoltage velocityVoltageRequest = new VelocityVoltage(0.0);

  // Torque-current control requests
  private final TorqueCurrentFOC torqueCurrentRequest = new TorqueCurrentFOC(0);
  private final MotionMagicExpoTorqueCurrentFOC motionMagicTorqueCurrentRequest =
  ...
  public void setDriveVelocity(double velocityRadPerSec, double accelerationRadPerSec2) {
    ...
    double accelRotPerSec2 = Units.radiansToRotations(accelerationRadPerSec2);
    driveTalon.setControl(
        switch (constants.DriveMotorClosedLoopOutput) {
          case Voltage -> velocityVoltageRequest
              .withVelocity(velocityRotPerSec)
              .withAcceleration(accelRotPerSec2);
  ...
  public void setTurnPosition(Rotation2d rotation) {
    turnTalon.setControl(
        switch (constants.SteerMotorClosedLoopOutput) {
          ...
          case TorqueCurrentFOC -> motionMagicTorqueCurrentRequest.withPosition(
